...
> Install `gcc`, `make`, and `git` on your system before building.
...
### 🟠 Ubuntu / Pop!\_OS / Zorin / mint / Elementary OS / kali / deepin
...
> **Note:** After installation, verify that the tools are available:
> ```sh
